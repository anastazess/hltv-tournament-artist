...
<div className="absolute left-0 top-0 h-full w-full max-w-[70%]">
  <img 
    ...
    style={{ transform: "translateX(0%) scale(1.4) translateY(14%)" }}
    onError={(e) => {
...
<div className="absolute right-16 top-1/2 transform -translate-y-80 text-right">
  ...
  <div className="text-white/25 font-black text-3xl mb-1 tracking-wide">
    {tournamentName}
  </div>

    {/* Прозрачный дубликат (как в оригинале) */}
  <div className="text-white/25 font-black text-3xl mb-5 tracking-wide">
    {tournamentName}
  </div>
  ...
  <div className="text-cyan-400/75 font-bold text-4xl mb-5 tracking-wider -mt-12">
    RATING
  </div>
