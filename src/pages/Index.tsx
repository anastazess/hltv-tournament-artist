...
<div className="absolute right-16 top-1/2 transform -translate-y-80 text-right">
  ...
  <div className="text-white font-black text-8xl mb-4 tracking-wider -translate-y-30">
    {rating}
  </div>
  <div className="text-cyan-400 font-bold text-2xl mb-12 tracking-wider -translate-y-30">
    RATING
  </div>
  
  <div className="text-white font-black text-7xl tracking-wider translate-y-30">
    {playerName}
  </div>
</div>
